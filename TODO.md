...
[] **Проверить соответствие моделей требованиям: убедиться, что каждая модель контента (услуги, товары, категории, новости, портфолио, производственные возможности и страницы) содержит обязательные поля: title, slug, SEO (meta_title, meta_description), is_published, published_at, created_by, updated_by, deleted_by, временные метки и soft‑delete. Эти поля уже описаны в миграциях**
